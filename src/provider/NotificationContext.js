    ...
    try {
      ...
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          const url = `${process.env.NEXT_PUBLIC_API_URL}/notifications/subscribe?latitude=${latitude}&longitude=${longitude}`;
          initializeSSE(url);
        },
        (error) => {
  ...
  const subscribe = useCallback(
    async (withLocation = false) => {
      ...
      if (withLocation) {
        ...
        const url = `${process.env.NEXT_PUBLIC_API_URL}/notifications/subscribe`;
